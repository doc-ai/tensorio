...
class TF22KerasCIFAR10MobileNetTest {
    ...
    fun testSavedModel() {
        try {
            val bundle = bundleForFile("keras-cifar10-mobilenet-save-model.tiobundle", "tf_2_2")
    ...
    fun testEstimatorPredict() {
        try {
            val bundle = bundleForFile("keras-cifar10-mobilenet-estimator-predict.tiobundle", "tf_2_2")
            Assert.assertNotNull(bundle)
    ...
    fun testEstimatorTrain() {
        try {
            val bundle = bundleForFile("keras-cifar10-mobilenet-estimator-train.tiobundle", "tf_2_2")
            Assert.assertNotNull(bundle)
