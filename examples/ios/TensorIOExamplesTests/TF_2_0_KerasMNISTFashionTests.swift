//
//  TF_2_0_KerasMNISTFashionTests.swift
...
class TF_2_0_KerasMNISTFashionTests: XCTestCase {
    ...
    func testModel_SaveModel() {
        ...
        let bundle = self.bundle(named: "keras-mnist-fashion-save-model.tiobundle", backend: "tf_2_0")!
    ...
    func testModel_ModelBuilder() {
        ...
        let bundle = self.bundle(named: "keras-mnist-fashion-model-builder.tiobundle", backend: "tf_2_0")!
        let model = self.model(with: bundle)!
    ...
    func testModel_EstimatorPredict() {
        ...
        let bundle = self.bundle(named: "keras-mnist-fashion-estimator-predict.tiobundle", backend: "tf_2_0")!
        let model = self.model(with: bundle)!
    ...
    func testModel_EstimatorTrain() {
        ...
        let bundle = self.bundle(named: "keras-mnist-fashion-estimator-train.tiobundle", backend: "tf_2_0")!
