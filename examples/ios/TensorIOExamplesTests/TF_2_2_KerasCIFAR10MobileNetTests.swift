//
//  TF_2_2_KerasCIFAR10MobileNetTests.swift
...
class TF_2_2_KerasCIFAR10MobileNetTests: XCTestCase {
    ...
    func testModel_SaveModel() {
        ...
        let bundle = self.bundle(named: "keras-cifar10-mobilenet-save-model.tiobundle", backend: "tf_2_2")!
    ...
    func testModel_EstimatorPredict() {
        ...
        let bundle = self.bundle(named: "keras-cifar10-mobilenet-estimator-predict.tiobundle", backend: "tf_2_2")!
        let model = self.model(with: bundle)!
    ...
    func testModel_EstimatorTrain() {
        ...
        let bundle = self.bundle(named: "keras-cifar10-mobilenet-estimator-train.tiobundle", backend: "tf_2_2")!
